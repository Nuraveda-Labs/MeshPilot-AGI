...
_PRODUCTS = (
    ...
    "mushroom",
    "immunity",
    # --- Petcare (pet supplements + chews) ---
    # Longer keys first to avoid prefix collisions.
    "hip-o-joint", "hipojoint", "hipjoint",
    "goodgut",
    "coolcalm", "cool-calm",
    "ashwagandha",                  # shared: Petcare chew + Namhya powder
    "turmeric",                     # Petcare chew + general Ayurvedic stem
    "hoj",                          # Petcare filename code for Hip-O-Joint
    "gg",                           # Petcare filename code for GoodGut
    "cc",                           # Petcare filename code for CoolCalm
    "yak",                          # Petcare yak cheese chews
    "joint",                        # Petcare joint-support framing
    "arthritis",
    "mobility",
    "limping",
    "dental",                       # Petcare yak chews angle
    "calming",                      # Petcare calming chew / CoolCalm
...
_PRODUCT_ALIASES = {
    ...
    "guduchi":      "giloy",
    "harad":        "haritaki",
    # Petcare — normalise short codes + variants to catalog names
    "hoj":          "hip-o-joint",
