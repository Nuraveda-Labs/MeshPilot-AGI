...
from meshpilot.config import brand_config, settings
from meshpilot.db.models import Signal
from meshpilot.media.image_gen import (
    generate_background,
)
...
- CTA slide: lift any link from the body (github.com/... or acmecorp.com)
...
def _draw_footer_wordmark(
    ...
    `wordmark` was the literal "acmecorp.com", so every brand's carousel footer carried GE's
